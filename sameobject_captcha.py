...
YOLOV5_DIR = ROOT_DIR / 'vendor' / 'yolov5'
            ...
            for _, det in enumerate(pred):
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        detections.append([class_index, self.labels[class_index], confidence_value, box])
                        """
                        ...
                        """
                if detections:
                    result[path] = sorted(detections, key=lambda item: (item[3][1], item[3][0]))
        return result
